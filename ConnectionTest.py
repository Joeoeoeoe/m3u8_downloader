...
class ConnectionTest:
    ...
    def connectionTest200(self, url=None, headers=None, printout=False):
        ...
        responseList = [[u, requests.get(u, h)] for u in urlList for h in headersList]
        ...
        list_of_not_200 = [item[1].status_code for item in responseList if item[1].status_code != 200]
